...
import br.net.convertix.dinix.service.ProductService;
...
public class ProductController {
    ...
    @GetMapping
    public PageResponse<ProductResponse> list(Paginacao paginacao) {
        return productService.list(SecurityUtils.currentUserId(), paginacao.toPageable());
    }

    @GetMapping("/{id}")
    public ProductResponse get(@PathVariable UUID id) {
        return productService.get(SecurityUtils.currentUserId(), id);
    }
